...
btn_sign_up = tk.Button(win, text='Sign Up', font='arial 15 bold', width=15, command=sign_up)
btn_sign_up.place(x=140, y=350)

btn_sign_in = tk.Button(win, text='Sign In', font='arial 15 bold', width=15 , command=sign_in)
